...
public class CalenderUtils {
    ...
    private static String CALENDARS_NAME = "meeting";
    private static String CALENDARS_ACCOUNT_NAME = "meeting@sjtu.edu.cn";
    private static String CALENDARS_ACCOUNT_TYPE = "com.android.meeting";
    private static String CALENDARS_DISPLAY_NAME = "meeting account";
    ...
    public static void addCalendarEvent(Context context, String title, String description, String date, int start, int end, String location) {
        ...
        long startMill = CommonUtils.getFormatTimeMill(CommonUtils.getFormatTime(date, start));
        long endMill = CommonUtils.getFormatTimeMill(CommonUtils.getFormatTime(date, end));
        ...
        Toast.makeText(context, "已成功添加日程", Toast.LENGTH_SHORT).show();
    }
